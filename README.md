# Whispers Beneath-The Triangle Hunt For The Leviathan
...
2. Build the project.
3. Flash to a compatible STM32L4 board.
4. Connect to USART2 using PuTTY or another serial terminal.
5. Reset the board and begin playing.
